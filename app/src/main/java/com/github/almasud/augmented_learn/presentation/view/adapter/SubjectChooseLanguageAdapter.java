...
import com.github.almasud.augmented_learn.databinding.SubjectChooseLanguageRowBinding;
 ...
 */
public class SubjectChooseLanguageAdapter extends RecyclerView.Adapter<SubjectChooseLanguageAdapter.LanguageViewHolder> {
    ...
    private SubjectChooseSubjectAdapter mChooseSubjectRVAdapter;
    ...
    public SubjectChooseLanguageAdapter(List<Language> languages, SubjectChooseActivity activity, int chooseService) {
    ...
    public void onBindViewHolder(@NonNull LanguageViewHolder holder, int position) {
        ...
        subjectsLivedData.observe(mActivity, subjects -> {
            if (!subjects.isEmpty()) {
                ...
                mChooseSubjectRVAdapter = new SubjectChooseSubjectAdapter(subjects, mActivity, mChooseService);
    ...
    public static class LanguageViewHolder extends RecyclerView.ViewHolder {
        private final SubjectChooseLanguageRowBinding chooseLanguageRowBinding;
