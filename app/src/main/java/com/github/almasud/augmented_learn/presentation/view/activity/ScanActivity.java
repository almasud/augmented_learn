...
import com.github.almasud.augmented_learn.presentation.view.fragment.ScanArFragment;
...
public class ScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(mViewBinding.toolbarScan.toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        // Set the visibility of safe area for Android 15 (API level 35) and above
        mViewBinding.toolbarScan.safeArea.setVisibility(Build.VERSION.SDK_INT >= Build.VERSION_CODES.VANILLA_ICE_CREAM ? View.VISIBLE : View.GONE);
        ...
        BaseApplication.changeToolbarTitleFont(
                ...
                Typeface.NORMAL, mViewBinding.toolbarScan.toolbar
        );
