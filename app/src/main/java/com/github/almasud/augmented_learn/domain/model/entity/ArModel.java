package com.github.almasud.augmented_learn.domain.model.entity;
...
public class ArModel implements Serializable {
    ...
    public ArModel(int id, String name, String photo, String fileName, Voice voice, Subject subject) {
        this.id = id;
        this.name = name;
        this.photo = photo;
