...
import com.github.almasud.augmented_learn.databinding.ActivityLearnArBinding;
...
import com.github.almasud.augmented_learn.presentation.view.adapter.LearnRVAdapter;
...
public class LearnArActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(mViewBinding.toolbarRealView.toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        // Set the visibility of safe area for Android 15 (API level 35) and above
        mViewBinding.toolbarRealView.safeArea.setVisibility(Build.VERSION.SDK_INT >= Build.VERSION_CODES.VANILLA_ICE_CREAM ? View.VISIBLE : View.GONE);
        ...
        BaseApplication.changeToolbarTitleFont(
                ...
                Typeface.NORMAL, mViewBinding.toolbarRealView.toolbar
        );
