...
import com.github.almasud.augmented_learn.presentation.view.adapter.LearnFSAdapter;
...
public class LearnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (getIntent().getBundleExtra(BaseApplication.BUNDLE) != null) {
        ...
        setSupportActionBar(mViewBinding.toolbarLearn.toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        // Set the visibility of safe area for Android 15 (API level 35) and above
        mViewBinding.toolbarLearn.safeArea.setVisibility(Build.VERSION.SDK_INT >= Build.VERSION_CODES.VANILLA_ICE_CREAM ? View.VISIBLE : View.GONE);
        ...
        BaseApplication.changeToolbarTitleFont(
                ...
                Typeface.NORMAL, mViewBinding.toolbarLearn.toolbar
        );
                ...
                if (BaseApplication.isSupportedAROrShowDialog(this)) {
                    ...
                    if (modelDirectory.listFiles().length > 1) {
                        ...
                        BaseApplication.setAlertDialog(
                                LearnActivity.this, getLayoutInflater().inflate(R.layout.custom_alert_dialog, null), getResources().getString(R.string.action_choose),
