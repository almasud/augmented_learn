package com.github.almasud.augmented_learn.presentation.view.adapter;
...
import com.github.almasud.augmented_learn.presentation.view.activity.LearnActivity;
import com.github.almasud.augmented_learn.presentation.view.activity.ScanActivity;
import com.github.almasud.augmented_learn.presentation.view.activity.SubjectChooseActivity;
import com.github.almasud.augmented_learn.presentation.view.activity.TestActivity;
 ...
 */
public class SubjectChooseSubjectAdapter extends RecyclerView.Adapter<SubjectChooseSubjectAdapter.SubjectViewHolder> {
    ...
    private final SubjectChooseActivity mActivity;
    private final int mChooseService;

    public SubjectChooseSubjectAdapter(List<Subject> subjects, SubjectChooseActivity activity, int chooseService) {
        mSubjects = subjects;
        mActivity = activity;
                    ...
                    new Handler().post(() -> {
                        ...
                        if (mChooseService == BaseApplication.LEARN) {
                            ...
                            if (BaseApplication.isSupportedAROrShowDialog(mActivity)) {
                                ...
                                Log.d(TAG, "onAnimationEnd: modelDirectory list: "+ Arrays.asList(Objects.requireNonNull(modelDirectory.list())));

                                // Check whether the model directory contains any item or not
                                if (Objects.requireNonNull(modelDirectory.listFiles()).length > 1) {
                                    BaseApplication.getInstance()
                                            .startNewActivity(
