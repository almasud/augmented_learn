...
import com.github.com.almasud.Augmented_School.view.fragment.ScanArFragment;
...
public class ScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LiveData<List<ArModel>> arModelListLiveData = arVM.getArModelsLivedData(((Subject) sBundle.getSerializable(ArModel.SUBJECT)).getId());
