...
import com.github.com.almasud.Augmented_School.view.adapter.LearnFSAdapter;
...
public class LearnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (getIntent().getBundleExtra(BaseApplication.BUNDLE) != null)
        ...
        LiveData<List<ArModel>> arModelsLiveData = arVM.getArModelsLivedData(((Subject) sBundle.getSerializable(ArModel.SUBJECT)).getId());
