...
public class ArViewModel extends AndroidViewModel {
    ...
    private List<ArModel> getBengaliVowels() {
        Subject subject = new Subject(
                Subject.VOWEL_BENGALI, mContext.getResources().getString(R.string.vowel_bengali),
                R.drawable.vowel_bengali, new Language(Language.BENGALI, mContext.getResources().getString(R.string.language_bengali)),
    ...
    private List<ArModel> getBengaliAlphabets() {
        Subject subject = new Subject(
                Subject.ALPHABET_BENGALI, mContext.getResources().getString(R.string.alphabet_bengali),
                R.drawable.alphabet_bengali, new Language(Language.BENGALI, mContext.getResources().getString(R.string.language_bengali)),
    ...
    private List<ArModel> getBengaliNumbers() {
        Subject subject = new Subject(
                Subject.NUMBER_BENGALI, mContext.getResources().getString(R.string.number_bengali),
                R.drawable.number_bengali, new Language(Language.BENGALI, mContext.getResources().getString(R.string.language_bengali)),
    ...
    private List<ArModel> getEnglishAlphabets() {
        Subject subject = new Subject(
                Subject.ALPHABET_ENGLISH, mContext.getResources().getString(R.string.alphabet_english),
                R.drawable.alphabet, new Language(Language.ENGLISH, mContext.getResources().getString(R.string.language_english)),
    ...
    private List<ArModel> getEnglishNumbers() {
        Subject subject = new Subject(
                Subject.NUMBER_ENGLISH, mContext.getResources().getString(R.string.number_english),
                R.drawable.number, new Language(Language.ENGLISH, mContext.getResources().getString(R.string.language_english)),
    ...
    private List<ArModel> getAnimals() {
        Subject subject = new Subject(
                Subject.ANIMAL_ENGLISH, mContext.getResources().getString(R.string.animal_english),
                R.drawable.animals, new Language(Language.ENGLISH, mContext.getResources().getString(R.string.language_english)),
    ...
    public LiveData<List<Language>> getLanguagesLivedData() {
        if (mMutableLiveDataListLanguage == null) {
            ...
            // Data should be fetched from cloud but we use static data here
            languages.add(new Language(Language.BENGALI, mContext.getResources().getString(R.string.language_bengali)));
            languages.add(new Language(Language.ENGLISH, mContext.getResources().getString(R.string.language_english)));
